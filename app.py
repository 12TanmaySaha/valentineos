...
# PAGE 2: Tiny things (clean + visible save)
...
# PAGE 3: Little quiz (prettier than radio dump)
...
# PAGE 4: Plan picker (fix ugly multiselect dropdown)
...
# PAGE 5: Memory lane (human prompts)
...
# PAGE 6: Final (keep what you liked)
else:
    card_open()
